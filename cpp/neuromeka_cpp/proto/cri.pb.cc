...
const char descriptor_table_protodef_cri_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_cri_2eproto_deps[2] = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_cri_2eproto = {
    false,
    false,
    1326,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_cri_2eproto),
         ::std::false_type{});
