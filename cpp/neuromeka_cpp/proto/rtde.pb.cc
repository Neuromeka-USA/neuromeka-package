...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_rtde_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_rtde_2eproto = nullptr;
...
static ::_pbi::once_flag descriptor_table_rtde_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_rtde_2eproto = {
    false, false, 1084, descriptor_table_protodef_rtde_2eproto,
    "rtde.proto",
    &descriptor_table_rtde_2eproto_once, descriptor_table_rtde_2eproto_deps, 2, 0,
    schemas, file_default_instances, TableStruct_rtde_2eproto::offsets,
    nullptr, file_level_enum_descriptors_rtde_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_rtde_2eproto(&descriptor_table_rtde_2eproto);
namespace Nrmk {
namespace IndyFramework {
